...
func main() {
	...
	// fmt.Println("Command example:", commands[0])

	// m := make(map[string]*Container)
	// m["1"] = &Container{}
	// m["1"].push("blah")

	// fmt.Println("Container 3:")
	// PrintContainer(*stack["3"])

	// fmt.Println("Now pop off the top...")
	// _ = stack["3"].pop()
	// PrintContainer(*stack["3"])

	// fmt.Println("Now add 'blah' to the top...")
	// stack["3"].push("blah")
	// PrintContainer(*stack["3"])
	...
	// c.push("B")
	// c.push("C")
	// fmt.Println("Container Contents:")
	// PrintContainer(c)

	// fmt.Println("Now pop twice...")
	// _ = c.pop()

	// fmt.Println("Container Contents:")
	// PrintContainer(c)

	// fmt.Println(PrintTop(c))
}
